    ...
    public void onClick(View v) {
        ...
        switch(v.getId())
        {
            ...
            case R.id.board_writeBtn :
                ...
                EditText titleET= writeBoardDialogView.findViewById(R.id.titleET);
                EditText boardKindET= writeBoardDialogView.findViewById(R.id.boardKindET);
                EditText bodyET= writeBoardDialogView.findViewById(R.id.bodyET);
