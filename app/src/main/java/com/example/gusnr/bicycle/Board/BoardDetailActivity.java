package com.example.gusnr.bicycle.Board;
...
import com.example.gusnr.bicycle.Data.DataManager;
import com.example.gusnr.bicycle.R;
import com.example.gusnr.bicycle.util.MyUtil;
...
public class BoardDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_board_detail_acitivty);
        ...
        replyListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ReplyDTO curItem = (ReplyDTO)replyAdapter.getItem(position);
    ...
    public void writeReply()
    {
        ...
        EditText writeReplyDialog_editText= writeReplyDialogView.findViewById(R.id.writeReplyDialog_editText);
